...
class Main {
    public static void main(String[] args) {
        ...
        Epreuve ep1l = new Epreuve(Style.TRAGÉDIE,  100);
        Epreuve ep2l = new Epreuve(Style.TRAGÉDIE, 150);
        Epreuve ep3l = new Epreuve(Style.TRAGÉDIE, 200);
        Epreuve ep1ma = new Epreuve(Style.TRAGÉDIE,  200);
        Epreuve ep2ma = new Epreuve(Style.TRAGÉDIE,  130);
        Epreuve ep3ma = new Epreuve(Style.TRAGÉDIE,  190);
        Epreuve ep1me = new Epreuve(Style.TRAGÉDIE,  140);
        Epreuve ep2me = new Epreuve(Style.TRAGÉDIE,  130);
        Epreuve ep3me = new Epreuve(Style.TRAGÉDIE,  109);
